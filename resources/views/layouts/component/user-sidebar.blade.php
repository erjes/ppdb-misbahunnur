<aside id="sidebar"
  ...
  <nav
    ...
    <ul class="space-y-2 px-3">
      <li>
        <a href="{{ route('registration.status') }}"
          class="group flex items-center space-x-3 px-5 py-2.5 rounded-lg text-sm font-medium transition-all duration-300 transform hover:translate-x-1
                          {{ request()->routeIs('registration.status') ? 'bg-green-700 text-white shadow-lg' : 'text-green-100 hover:bg-green-700/70 hover:text-white' }}">
          <i
            class="fa-solid fa-clipboard-list w-5 text-center transition-transform duration-300 group-hover:scale-110"></i>
          <span class="sidebar-text">Status Pendaftaran</span>
      ...
      <li>
        <a href="{{ route('registration.documents') }}"
          class="group flex items-center space-x-3 px-5 py-2.5 rounded-lg text-sm font-medium transition-all duration-300 transform hover:translate-x-1
                          {{ request()->routeIs('registration.documents') ? 'bg-green-700 text-white shadow-lg' : 'text-green-100 hover:bg-green-700/70 hover:text-white' }}">
          <i
            class="fa-solid fa-file-upload w-5 text-center transition-transform duration-300 group-hover:scale-110"></i>
          <span class="sidebar-text">Upload Dokumen</span>
          <span class="ml-auto opacity-0 group-hover:opacity-100 transition-opacity duration-300 sidebar-text">
            <i class="fa-solid fa-chevron-right text-xs"></i>
          </span>
        </a>
