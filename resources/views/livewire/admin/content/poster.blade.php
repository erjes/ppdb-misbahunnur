    ...
    <div class="p-6">
      <form wire:submit.prevent="uploadPoster" class="space-y-6">
        ...
        <div class="flex gap-3">
          <button type="submit"
            class="flex-1 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white font-semibold px-6 py-3 rounded-lg shadow-md transition-all duration-300 transform hover:-translate-y-0.5 flex items-center justify-center">
          ...
          @foreach ($posters as $posterItem)
            <div
              ...
              <div class="relative group">
                <img src="{{ asset('storage/' . $posterItem->filename) }}" alt="Poster"
