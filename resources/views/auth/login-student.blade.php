<x-guest-layout>
    <div class="flex flex-col md:flex-row min-h-screen">
        ...
        <div class="hidden md:flex md:w-1/2 bg-gray-100 items-center justify-center p-12">
            <div class="max-w-md">
                <img src="{{ asset('images/logo.png') }}" alt="Ilustrasi Login Siswa" class="w-full h-auto">
            </div>
        </div>
        ...
        <div class="w-full md:w-1/2 bg-green-800 flex items-center justify-center p-8 md:p-12">
            <div class="w-full max-w-sm">
                ...
                <p class="text-green-200 mb-6 text-center md:text-left">
                    {{ __('Masuk dengan nomor pendaftaran dan NISN') }}
                </p>
                ...
                <form method="POST" action="{{ route('student.authenticate') }}">
                    ...
                    <div class="mt-4">
                        <div class="flex items-center justify-between">
                            <x-input-label for="password" value="{{ __('NISN') }}" class="text-green-100" />
                        </div>
